  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y: backgroundY }} className="absolute inset-0 -z-10">
        <VideoBackground
          posterSrc="https://club-mareva.s3.eu-west-2.amazonaws.com/library/Mareva20260326-L0007-5d8f077e4f74-large.webp"
          fallbackImageSrc="https://club-mareva.s3.eu-west-2.amazonaws.com/library/Mareva20260326-L0007-5d8f077e4f74-large.webp"
