...
export default function PostClient({ post, relatedPosts }: PostClientProps) {
  ...
  // When body has NO inline images, distribute gallery images between text blocks (legacy behaviour)
  const contentSegments = useMemo(() => {
    if (hasInlineImages || post.images.length === 0) return null;
    ...
    return segments;
  }, [post.content, post.images, hasInlineImages]);
    ...
    <main className="min-h-screen bg-black pt-24">
      ...
      >
        {hasInlineImages || !contentSegments ? (
          ...
          /* No inline images — distribute gallery images between text blocks */
